...
import cn.youngkbt.generic.common.http.annotation.resolver.RequestUriArgumentResolver;
import cn.youngkbt.generic.common.http.annotation.resolver.RequestUrlArgumentResolver;
import cn.youngkbt.generic.common.log.LogInterceptor;
...
public class WebConfigurerAdapter implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(securityInterceptor())
                .addPathPatterns("/category/**", "/service/**", "/field/**", "/report/**", "/serviceCol/**",
